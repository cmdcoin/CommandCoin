...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1531785600, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 10 * 60; // Cmd: 3 blocks
        nTargetSpacing = 3 * 60;  // Cmd: 3 minute
        nMaturity = 15;
        nMasternodeCountDrift = 1;
        nMaxMoneyOut = 230000000 * COIN;

        /** Height or Time Based Activations **/
        nLastPOWBlock = 10000;
        nModifierUpdateBlock = 1; // we use the version 2 for CMD
        ...
        // DNS Seeding
        vSeeds.push_back(CDNSSeedData("seed1.commandcoin.net", "seed1.commandcoin.net"));
        vSeeds.push_back(CDNSSeedData("seed2.commandcoin.net", "seed2.commandcoin.net"));
        vSeeds.push_back(CDNSSeedData("seed3.commandcoin.net", "seed3.commandcoin.net"));
        vSeeds.push_back(CDNSSeedData("seed4.commandcoin.net", "seed4.commandcoin.net"));
	
        // Cmd addresses start with 'Y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 28);
        // Cmd script addresses start with '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 28);
        // Cmd private keys start with '9' or 'A'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 28);
        // Cmd BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Cmd BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // Cmd BIP44 coin type is '57612'
        ...
        strMasternodePoolDummyAddress = "Y9J4Qad4xc77PpLzMx6rUegAs6aUPWkcUq";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Cmd: 1 day
        nTargetSpacing = 3 * 60;  // Cmd: 3 minute
        nLastPOWBlock = 500;
        nMaturity = 15;
        ...
        // Testnet Cmd addresses start with 'n'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 28);
        // Testnet Cmd script addresses start with '5'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 28);
        // Testnet private keys start with '5' or 'n' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 28);
        // Testnet Cmd BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Cmd BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet Cmd BIP44 coin type is '1' (All coin's testnet default)
        ...
        strMasternodePoolDummyAddress = "n5JVWUkt6HtSCY2SaJ2akeyJUg8bg1hW3S";
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Cmd: 1 day
        nTargetSpacing = 3 * 60;        // Cmd: 3 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
