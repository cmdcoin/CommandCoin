...
/* Cmd GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Cmd"
#define QAPP_ORG_DOMAIN "commandcoin.net"
#define QAPP_APP_NAME_DEFAULT "Cmd-Qt"
#define QAPP_APP_NAME_TESTNET "Cmd-Qt-testnet"
