...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cmd features */
        {"cmd", "masternode", &masternode, true, true, false},
        {"cmd", "listmasternodes", &listmasternodes, true, true, false},
        {"cmd", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cmd", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cmd", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cmd", "masternodedebug", &masternodedebug, true, true, false},
        {"cmd", "startmasternode", &startmasternode, true, true, false},
        {"cmd", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cmd", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cmd", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cmd", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cmd", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cmd", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cmd", "mnbudget", &mnbudget, true, true, false},
        {"cmd", "preparebudget", &preparebudget, true, true, false},
        {"cmd", "submitbudget", &submitbudget, true, true, false},
        {"cmd", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cmd", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cmd", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cmd", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cmd", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cmd", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cmd", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cmd", "checkbudgets", &checkbudgets, true, true, false},
        {"cmd", "mnsync", &mnsync, true, true, false},
        {"cmd", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> cmd-cli " + methodname + " " + args + "\n";
}
