...
RESOURCES += src/qt/cmd.qrc src/qt/cmd_locale.qrc

TRANSLATIONS += src/qt/locale/cmd_bg.ts \
                src/qt/locale/cmd_de.ts \
                src/qt/locale/cmd_en.ts \
                src/qt/locale/cmd_es.ts \
                src/qt/locale/cmd_fi.ts \
                src/qt/locale/cmd_fr.ts \
                src/qt/locale/cmd_it.ts \
                src/qt/locale/cmd_ja.ts \
                src/qt/locale/cmd_pl.ts \
                src/qt/locale/cmd_pt.ts \
                src/qt/locale/cmd_ru.ts \
                src/qt/locale/cmd_sk.ts \
                src/qt/locale/cmd_sv.ts \
                src/qt/locale/cmd_vi.ts \
                src/qt/locale/cmd_zh_CN.ts \
                src/qt/locale/cmd_zh_TW.ts
