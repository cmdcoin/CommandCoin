...
#   c) node1 mines 32 blocks, so now node 0 has 500000CMD, node 1 has 4250CMD, node2 has none.
#   d) node0 sends 601 CMD to node2, in two transactions (301 CMD, then 300 CMD).
