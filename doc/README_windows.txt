...
Intro
-----
Cmd (CMD) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Cmd utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run cmd-qt.exe.

Cmd Core is the original Cmd client and it builds the backbone of the network.
However, it downloads and stores the entire history of Cmd transactions;
