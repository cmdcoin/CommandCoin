...
This mechanism has been integrated into Bitcore-Node-Cmd which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/commandcoin/insight-api-cmd#web-socket-api](https://github.com/commandcoin/insight-api-cmd#web-socket-api)
* API: [https://github.com/commandcoin/insight-api-cmd#swifttx-transactions](https://github.com/commandcoin/insight-api-cmd#swifttx-transactions)
...
By default, the Cmd Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Cmd Core daemon:
