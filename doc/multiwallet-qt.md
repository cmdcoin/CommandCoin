...
In order to support loading of multiple wallets in cmd-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cmd.cpp.
...
Changes to cmd.cpp
----------------------
cmd.cpp is the entry point into cmd-qt, and as such, will require some minor modifications to provide hooks for
