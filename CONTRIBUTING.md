...
The Cmd Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cmd Core project, and is not to be
confused with overall Cmd Network Protocol consensus changes.

Whether a pull request is merged into Cmd Core rests with the project merge
...
Patches that change Cmd consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cmd consensus, it must have been
